      ...
      <el-col :span="8">
        ...
        >
          ...
          >
            ...
            <el-button
              type="primary"
              @click="dialog2 = false;pushtomech(1)"
            >确 定</el-button>
          </div>
        </el-dialog>
        <!-- 远程推送记录2 -->
        ...
        >
          ...
          >
            ...
            <el-button
              type="primary"
              @click="dialog3 = false;pushtomech(2)"
            >确 定</el-button>
          </div>
        </el-dialog>
...
export default {
  data () {
    return {
      ...
      zzj: '',//推送的自助机
      dealtype: '',
      dealtype1: [{ dealId: '1', dealvalue: '临时' }, { dealId: '3', dealvalue: '月租' }, { dealId: '2', dealvalue: '群租' }],
      tagtype: '',
  ...
  methods: {
    ...
    pushtomech (tag) {
      ...
      this.mechineinfo.datas.pushTag = tag
